<?php 
	...
	// 如果有登入的Session 或者 登入的Session是 True的話
...
<!-- 	<audio autoplay="autoplay" loop="loop">
		<source src="img/613289747.553827.mp4" type="audio/mpeg" />
		如果不播放，說明你的瀏覽器不支持！
	</audio> -->
			...
			<nav class="navbar navbar-expand-lg nav-box">
			  ...
			  <div class="collapse navbar-collapse" id="navbarSupportedContent">
			    ...
			    <ul class="navbar-nav ml-auto">
			      <li class="nav-item">
			        <a class="nav-link nav-link-font" href="main.php" >Home</a>
			      </li>
			      ...
			      <li class="nav-item dropdown"  style="transition: .7s;">
			        <a class="nav-link dropdown-toggle user-Navitem" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color:#999;">
					...
					<!-- Under Font -->
			         <label class = "user_font" style="color:#999;">未登入</label>								
			        </a>
			        ...
			        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
			         	...
			         	<div class="header-user-box">			         		
			         		<i class="fas fa-child header-user-img"></i>			         		
			         	</div>
						
						<!-- User's Name -->
			         	<div class="header-user-box">
			         		<Label class="header-user-name">使用者名稱</label>
						</div>
			          ...
			          <!-- 登入時才顯現 -->
			          <!-- <a class="dropdown-item" href="#">使用者管理</a> -->
			         <!--  <div class="dropdown-divider"></div>
